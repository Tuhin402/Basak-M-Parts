            ...
            <div class="container-fluid">
                ...
                <div class="page-header my-3">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">B2B Banner</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                <li class="breadcrumb-item">General Banner</li>
                                <li class="breadcrumb-item active">B2B Banner</li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="table-responsive table-centered">
                                <table class="table mb-0 table-hover">
                                    ...
                                    <tbody id="categoryTable">
                                        <?php
                                            $cnt = 0;
                                            $totalBanners = $obj->fetch("SELECT COUNT(*) AS total FROM banner_two")[0]['total'];
                                            $banners = $obj->fetch("SELECT * FROM banner_two ORDER BY id DESC");
                                            foreach ($banners as $val) { 
                                                $cnt++; 
                                        ?>
                                        <tr>
                                            <td><?php echo $cnt;?></td>
                                            <td><img src="uploads/banner/<?php echo $val['b2b_image']?>" alt="Banner" width="200px" height="100px" class="img-fluid rounded"></td>
                                            <td>
                                                        ...
                                                        <form class="editBannerForm" enctype="multipart/form-data">
                                                            ...
                                                            <div class="mb-3">
                                                                <div class="d-flex align-items-center">
                                                                    <img src="uploads/banner/<?php echo $val['b2b_image']; ?>" alt="Banner Image" class="img-fluid me-3" style="max-height: 100px; border-radius: 10px;">
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body text-center">
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-center">
                                                            <img src="uploads/banner/<?php echo $val['b2b_image']; ?>" alt="banner Image" class="img-fluid me-3" style="max-height: 200px; border-radius: 10px;">
                                                        </div>
