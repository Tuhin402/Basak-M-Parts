                            ...
                            <div class="table-responsive table-centered">
                                <table class="table mb-0 table-hover">
                                    ...
                                    <tbody id="policyTable">
                                        <?php
                                            $cnt = 0;
                                            $totalPolicies = $obj->fetch("SELECT COUNT(*) AS total FROM ship")[0]['total'];
                                            $policies = $obj->fetch("SELECT * FROM ship ORDER BY id DESC");
