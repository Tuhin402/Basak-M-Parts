            ...
            <div class="container-fluid">
                ...
                <div class="page-header my-3">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Guide Videos</h3>
                            <ul class="breadcrumb">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <h4 class="card-title">Our Tutorial Videos</h4>
                                ...
                                <table class="table mb-0 table-hover">
                                    <thead class="bg-light bg-opacity-50">
                                        <tr>
                                            ...
                                            <th><a href="javascript:void(0);">Video Link</a></th>
                                            <th><a href="javascript:void(0);">Thumbnail</a></th>
                                    ...
                                    <tbody id="videosTable">
                                        <?php
                                            $cnt = 0;
                                            $totalVideos = $obj->fetch("SELECT COUNT(*) AS total FROM videos")[0]['total'];
                                            $videos = $obj->fetch("SELECT * FROM videos ORDER BY id DESC");
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="uploads/videos/<?php echo $val['image']?>" alt="popular" class="img-fluid rounded" width="160" style="aspect-ratio: 16 / 9;"></td>
                                            <td>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header bg-light">
                                                        <h4 class="modal-title" id="editModalLabel<?php echo $val['id']; ?>">Edit Video</h4>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form class="editVideoForm" enctype="multipart/form-data">
                                                            <input type="hidden" name="vdo_id" value="<?php echo $val['id']; ?>">
                                                            <div class="mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                <div class="d-flex align-items-center">
                                                                    <img src="uploads/videos/<?php echo $val['image']; ?>" alt="Thumbnail" class="img-fluid me-3 rounded" style="width: 160px; aspect-ratio: 16 / 9;">
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h3 class="modal-title" id="deleteModalLabel<?php echo $val['id']; ?>">Delete Video</h3>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body text-center">
                                                        <p>Are you sure you want to delete this tutorial?</p>
                                                        <div class="d-flex align-items-center justify-content-center">
                                                            <img src="uploads/videos/<?php echo $val['image']; ?>" alt="Tutorial Thumbnail" class="img-fluid me-3 rounded" style="width: 200px; aspect-ratio: 16 / 9;">
                                                        </div>
                                                        <form class="deleteVideoForm">
                                                            <input type="hidden" name="vdo_id" value="<?php echo $val['id']; ?>">
                                                        </form>
                                                    </div>
                            ...
                            <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h3 class="modal-title" id="addModalLabel">Add Video</h3>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <form id="videoFormAdd">
                                                <div class="mb-3">
                                                    <label for="link" class="form-label">Video Link <span style="color:red;">*</span></label>
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-primary" id="saveVideo">Save</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-sm">
                                        <div class="text-muted">
                                            Total <span class="fw-semibold" id="totalVideos"><?php echo $totalVideos; ?></span> entries.
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    document.getElementById("saveVideo").addEventListener("click", function() {
        let form = document.getElementById("videoFormAdd");
        let formData = new FormData(form);
        if (!formData.get("link") || !formData.get("image").name) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.trim() === "success") {
                        ...
                        Toastify({
                            text: "Error deleting video. Try again.",
                            duration: 2000,
                            gravity: "top",
                            position: "center",
