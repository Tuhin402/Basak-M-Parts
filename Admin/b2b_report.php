                ...
                <div class="container-xxl">
                    ...
                    <div class="page-header my-3">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="page-title">B2B Reports</h3>
                                <ul class="breadcrumb">
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="d-flex card-header justify-content-between align-items-center">
                                    <div><h4 class="card-title">B2B Order List</h4></div>
                                ...
                                <div class="card-body p-0">
                                    <div class="table-responsive">
                                        <table id="b2b_report_table" class="table align-middle mb-0 table-hover table-centered">
                                            ...
                                            <tbody id="b2b_report">
                                                <?php
                                                $cnt = 0;
                                                $orders = $obj->fetch("SELECT o.order_id, o.date, o.user_name, SUM(o.total_price) AS total_price, o.status, SUM(o.quantity) AS quantity, o.ship_status FROM orders o JOIN products p ON o.price = p.b2b_price GROUP BY o.order_id ORDER BY o.date DESC");
...
<script>
    ...
    $(document).ready(function () {
        $("#saveDate").click(function () {
            ...
            if (startDate && endDate) {
                $.ajax({
                    url: "filter_b2b_report.php",
                    type: "POST",
                    data: { startDate: startDate, endDate: endDate },
                    success: function (response) {
                        $("#b2b_report").html(response); 
    ...
    document.getElementById("exportExcel").addEventListener("click", function () {
        ...
        try {
            let table = document.getElementById("b2b_report_table"); 
            let wb = XLSX.utils.book_new(); 
            let ws = XLSX.utils.table_to_sheet(table); 
            XLSX.utils.book_append_sheet(wb, ws, "B2B_Report"); 
            XLSX.writeFile(wb, "B2B_Report.xlsx");
            Toastify({
