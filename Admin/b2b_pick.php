            ...
            <div class="container-fluid">
                ...
                <div class="page-header my-3">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Popular Offer B2B</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                <li class="breadcrumb-item">Popular Offer</li>
                                <li class="breadcrumb-item active">B2B Offer</li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="table-responsive table-centered">
                                <table class="table mb-0 table-hover">
                                    ...
                                    <tbody id="dealsTable">
                                        <?php
                                            $cnt = 0;
                                            $totalDeals = $obj->fetch("SELECT COUNT(*) AS total FROM popular_picks_b2b")[0]['total'];
                                            $deals = $obj->fetch("SELECT * FROM popular_picks_b2b ORDER BY id DESC");
