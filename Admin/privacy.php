                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <h4 class="card-title">Privacy Table</h4>
                            ...
                            <div class="table-responsive table-centered">
                                <table class="table mb-0 table-hover">
                                    ...
                                    <tbody id="policyTable">
                                        <?php
                                            $cnt = 0;
                                            $totalPolicies = $obj->fetch("SELECT COUNT(*) AS total FROM privacy")[0]['total'];
                                            $policies = $obj->fetch("SELECT * FROM privacy ORDER BY id DESC");
