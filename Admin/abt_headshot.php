                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <a href="" class="btn btn-sm btn-soft-primary" data-bs-toggle="modal" data-bs-target="#addModal">
                                        <i class="bx bx-plus me-1"></i>Add Content
                                    </a>
                                </div>
                            </div>
                            <!--Table start
                            ...
                            <div class="table-responsive table-centered">
                                <table class="table mb-0 table-hover">
                                    ...
                                    <tbody id="aboutTable">
                                        <?php
                                            $cnt = 0;
                                            $totalAbout = $obj->fetch("SELECT COUNT(*) AS total FROM about_headshot")[0]['total'];
                                            $abouts = $obj->fetch("SELECT * FROM about_headshot ORDER BY id DESC");
                                            foreach ($abouts as $val) { 
                                                $cnt++; 
                                        ?>
                                        <tr>
                                            <td><?php echo $cnt;?></td>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header bg-light">
                                                        <h4 class="modal-title" id="editModalLabel<?php echo $val['id']; ?>">Edit Deal</h4>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form class="editAboutForm" enctype="multipart/form-data">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h3 class="modal-title" id="deleteModalLabel<?php echo $val['id']; ?>">Delete About</h3>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body text-center">
                                                        <p>Are you sure you want to delete this About?</p>
                                                        <p><strong><?php echo $val['title']; ?></strong></p>
                                                        <form class="deleteAboutForm">
                                                            <input type="hidden" name="abt_id" value="<?php echo $val['id']; ?>">
                                                        </form>
                                                    </div>
                            ...
                            <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h3 class="modal-title" id="addModalLabel">Add Content for About</h3>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <form id="aboutFormAdd">
                                                <div class="mb-3">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-primary" id="saveAbout">Save</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-sm">
                                        <div class="text-muted">
                                            Total <span class="fw-semibold" id="totalAbout"><?php echo $totalAbout; ?></span> entries.
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    document.getElementById("saveAbout").addEventListener("click", function() {
        let form = document.getElementById("aboutFormAdd");
        let formData = new FormData(form);
        if (!formData.get("title") || !formData.get("des")) {
            showToast("Please fill all fields", "error");
            return;
        }
        fetch("add_abt_headshot.php", {
            method: "POST",
            body: formData
        })
        .then(res => res.json())
