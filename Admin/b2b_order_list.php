                    ...
                    <div class="container-xxl">
                         ...
                         <div class="page-header my-3">
                              <div class="row align-items-center">
                                   <div class="col">
                                        <h3 class="page-title">B2B Orders</h3>
                                        <ul class="breadcrumb">
                                             <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                             <li class="breadcrumb-item">Orders</li>
                                             <li class="breadcrumb-item active">B2B Orders</li>
                                        </ul>
                                   </div>
                              </div>
                         </div>
                         ...
                         <div class="row">
                              <!-- Revenue -->
                              <?php
                              $revenueData = $obj->fetch("SELECT SUM(o.total_price) AS total_revenue FROM orders o INNER JOIN products p ON o.price = p.b2b_price");
                              ...
                              <!-- Payment Complete -->
                              <?php
                              $paidOrdersCount = $obj->fetch("SELECT COUNT(DISTINCT o.order_id) AS total_paid_orders FROM orders o INNER JOIN products p ON o.price = p.b2b_price WHERE o.status = 'paid'");
                              ...
                              <!-- Cash on Delivery -->
                              <?php
                              $codOrdersCount = $obj->fetch("SELECT COUNT(DISTINCT o.order_id) AS total_paid_orders FROM orders o INNER JOIN products p ON o.price = p.b2b_price WHERE o.status = 'cod'");
                              ...
                              <div class="col-xl-12">
                                   <div class="card">
                                        <div class="d-flex card-header justify-content-between align-items-center">
                                             <div><h4 class="card-title">All B2B Order List</h4></div>
                                        </div>
                                        <div class="card-body p-0">
                                             <div class="table-responsive">
                                                  <table class="table align-middle mb-0 table-hover table-centered">
                                                       ...
                                                       <tbody>
                                                            <?php
                                                            $orders = $obj->fetch("SELECT o.order_id, o.date, o.user_name, o.order_status, o.refund_status, SUM(o.total_price) AS total_price, o.status, SUM(o.quantity) AS quantity, o.ship_status FROM orders o JOIN products p ON o.price = p.b2b_price GROUP BY o.order_id ORDER BY o.date DESC");
