...
if (isset($_POST['company'])) {
    ...
    $products = $obj->fetch("SELECT * FROM products WHERE company_id = '$company' ORDER BY last_updated DESC");
    ...
    if($products) {
        ...
        echo "<tr><td colspan='7' class='text-center'>No data found for the selected company.</td></tr>";
    }
}
?>