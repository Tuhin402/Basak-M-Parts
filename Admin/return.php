            ...
            <div class="container-fluid">
                ...
                <div class="page-header my-3">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="page-title">Return Policy</h3>
                            <ul class="breadcrumb">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <h4 class="card-title">Return Policy Table</h4>
                            ...
                            <div class="table-responsive table-centered">
                                <table class="table mb-0 table-hover">
                                    ...
                                    <tbody id="policyTable">
                                        <?php
                                            $cnt = 0;
                                            $totalPolicies = $obj->fetch("SELECT COUNT(*) AS total FROM return_policy")[0]['total'];
                                            $policies = $obj->fetch("SELECT * FROM return_policy ORDER BY id DESC");
