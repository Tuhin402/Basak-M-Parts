...
if (isset($_POST['startDate']) && isset($_POST['endDate'])) {
    ...
    $orders = $obj->fetch("SELECT o.order_id, o.date, o.user_name, SUM(o.total_price) AS total_price, o.status, SUM(o.quantity) AS quantity, o.ship_status FROM orders o JOIN products p ON o.price = p.b2c_price WHERE o.date BETWEEN '$startDate' AND '$endDate' GROUP BY o.order_id ORDER BY o.date DESC");
