                ...
                <div class="container-xxl">
                    ...
                    <div class="page-header my-3">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="page-title">Pending Cancellations</h3>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                                    <li class="breadcrumb-item">Order Cancellation</li>
                                    <li class="breadcrumb-item active">Pending Cancellations</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="d-flex card-header justify-content-between align-items-center">
                                    <div><h4 class="card-title">Pending Cancellation List</h4></div>
                                </div>
                                                ...
                                                <div class="modal-content shadow-sm">
                                                    <form id="refundForm<?= $cancel_id; ?>" enctype="multipart/form-data">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="refundModalLabel<?= $cancel_id; ?>">Confirm Cancellation</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="text-center p-3">
                                                                <div class="d-flex justify-content-center align-items-center fs-1 mb-2">
                                                                    <iconify-icon icon="solar:question-circle-bold-duotone" class="text-primary display-1"></iconify-icon>
                                                                </div>
                                                                <p class="text-muted fw-semibold text-wrap">Are you sure you want to approve the cancellation for Order ID <strong class="text-dark fw-bold">#<?= $val['order_id']; ?></strong>?</p>
                                                            </div>
                                                            <?php endif; ?>
                                                        </div>
