...
<body class="preload-wrapper">
    ...
    <div id="wrapper">
        ...
        <div class="page-title" style="background-image: url('../Admin/uploads/banner/<?= htmlspecialchars($ban['b2c_image']) ?>');">
            <div class="container">
                <h3 class="heading text-center">B2C Registration</h3>
                <ul class="breadcrumbs d-flex align-items-center justify-content-center">
                    <li><a class="link" href="index.php">Home</a></li>
                    <li><i class="icon-arrRight"></i></li>
                    <li>B2C Registration</li>
                </ul>
            </div>
        </div>
        <?php } ?>
        ...
        <section class="flat-spacing">
            <div class="container">
                <div class="login-wrap">
                    <div class="left">
                        <div class="heading">
                            <h4>Business to Customer Registration</h4>
                        </div>
                        <form id="regBtoC" class="form-login form-has-password">
                            <div class="wrap">
                                <div class="row g-3">
                                ...
                                <a href="../b2b/register_B_to_B.php" class="font-2 text-button forget-password link" style="color: #EB5831;">Business to Business Registration -></a>
                            </div>
    ...
    <script>
        ...
        sendOtpBtn.addEventListener('click', () => {
            ...
            if (email && phone && address && state && district && landmark && pin && name) {
        ...
        verifyOtpBtn.addEventListener('click', () => {
            ...
            if (enteredOtp == generatedOtp) {
                ...
                const phone = document.querySelector('input[name="phone"]').value;
                const addressOne = document.querySelector('input[name="addressOne"]').value;
                const addressTwo = document.querySelector('input[name="addressTwo"]').value;
                const state = document.querySelector('input[name="state"]').value;
                const district = document.querySelector('input[name="district"]').value;
                const landmark = document.querySelector('input[name="landmark"]').value;
                const pin = document.querySelector('input[name="pin"]').value;
                ...
                fetch('register_btoc.php', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({ name, email, phone, addressOne, addressTwo, state, district, landmark, pin, password, cpassword })
                })
                    .then(response => response.json())
                    .then(data => {
                        if (data.success) {
