        ...
        <?php
            if ($product_id) {
                $query = "SELECT p.id, p.name AS product_name, p.description, p.sku, p.part, 
                        p.mrp, p.gst, p.b2c_price, p.b2c_discount, p.b2c_special_discount, p.stock, p.best_seller, p.image_1, p.image_2, p.image_3, p.image_4, 
                ...
                if (!empty($result)) {
                    ...
                    $b2c_discount = $product['b2c_discount'];
                    $b2c_special_discount = $product['b2c_special_discount'];
                                ...
                                <div class="tf-product-info-list other-image-zoom">
                                    <div class="tf-product-info-heading">
                                        <div class="tf-product-info-name">
                                            ...
                                            <h3 class="name text-wrap"><?= htmlspecialchars($product_name) ?></h3>
                                            <?php if($best_seller == 'yes') { ?>
                                            <span class="badge border border-danger text-primary fw-bold px-3 py-2 rounded-pill mb-3 me-1"><i class="bi bi-star-fill me-1"></i> Best Seller</span>
                                            <?php } ?>
                                            <div class="sub">
                                                ...
                                                <?php if($b2c_special_discount != 0) { ?>
                                                <div class="tf-product-info-sold">
                                                    <i class="icon icon-lightning"></i>
                                                    <div class="text text-caption-1 line-under">Get <span class="text-primary fw-bold"><?= $b2c_special_discount ?>%</span> additional discount on online payment!</div>
                                                </div>
                                                <?php } ?>
                                            </div>
                                        </div>
                                        <div class="tf-product-info-desc">
                                            <div class="tf-product-info-price">
                                                <h5 class="price-on-sale font-2">₹<span id="base-price"><?= htmlspecialchars($b2c_price) ?></span></h5>
                                                <div class="compare-at-price font-2"><?= htmlspecialchars($mrp) ?></div>
                                                <?php if($b2c_discount != 0) { ?>
                                                <div class="badges-on-sale text-btn-uppercase">-<?= htmlspecialchars($b2c_discount) ?>%</div>
                                                <?php } ?>
                                            </div>
                                    ...
                                    <div class="tf-product-info-choose-option">
                                        ...
                                        <div>
                                            <div class="tf-product-info-by-btn mb_10">
                                                <button type="button" class="btn-style-2 flex-grow-1 text-btn-uppercase fw-6 add-to-cart border-0" data-product-id="<?= $product_id ?>" data-price="<?= $b2c_price ?>">
                                                    <span>Add to cart -&nbsp;</span>
                                                    <span class="total_price">₹<span class="total_amount"><?= htmlspecialchars($b2c_price) ?></span></span>
                                                </button>
                                                ...
                                                <button type="button" class="btn btn-outline-dark box-icon hover-tooltip wishlist btn-icon-action p-3" data-product-id="<?= $product_id ?>" data-price="<?= $product['b2c_price'] ?>">
                                            ...
                                            <button type="button" class="btn-style-3 text-btn-uppercase border-0" id="buy_now_btn" style="width: 100%; color: white;">
                                                <span>Buy Now -&nbsp;</span>
                                                <span class="total_price">₹<span  id="total_price" class="total_amount"><?= htmlspecialchars($b2c_price) ?></span></span>
                                            </button>
                                        </div>
                    ...
                    <div class="col-12">
                        <div class="widget-tabs style-1">
                            <ul class="widget-menu-tab">
                                ...
                                <li class="item-title"><span class="inner">Shipping Policies</span></li>
