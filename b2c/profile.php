...
<body class="preload-wrapper">
    ...
    <div id="wrapper">
        ...
        <!-- profile -->
        <?php 
        $sql = "SELECT * FROM reg_btoc WHERE id = $userId";
                    ...
                    <div class="wrap-sidebar-account">
                        <div class="sidebar-account">
                            <div class="account-avatar">
                                <div class="profile-user-circle mb_20" style="width: 150px; height: 150px; background-color: #8E1616; color: #fff; border: 5px solid #F95454; border-radius: 50%; display: flex; justify-content: center; align-items: center; font-size: 72px; font-weight: bold; text-transform: uppercase;">
                            ...
                            <ul class="my-account-nav">
                                ...
                                <a href="logout.php" class="my-account-nav-item">Logout</a>
                            </ul>
                        </div>
                    </div>
