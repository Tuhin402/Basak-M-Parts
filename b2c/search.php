        ...
        <div class="modal-content">
            ...
            <div class="form-search">
                <form action="search_part.php" method="GET" novalidate>
                    <fieldset class="text">
                    <input type="text" name="part_no" placeholder="Search by Part No." required>
                    </fieldset>
                    <button type="submit">
                    <svg class="icon" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11 19C15.4183 19 19 15.4183 19 11C19 6.58172 15.4183 3 11 3C6.58172 3 3 6.58172 3 11C3 15.4183 6.58172 19 11 19Z" stroke="#181818" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
            ...
            <div class="form-search">
                <form action="shop_by_company.php" method="GET" novalidate>
                    <fieldset class="text">
                    <input type="text" name="company_name" placeholder="Search by Company." required>
                    </fieldset>
                    <button type="submit">
                    <svg class="icon" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11 19C15.4183 19 19 15.4183 19 11C19 6.58172 15.4183 3 11 3C6.58172 3 3 6.58172 3 11C3 15.4183 6.58172 19 11 19Z" stroke="#181818" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                    ...
                    <div class="col-6 col-xl-3 col-lg-3 col-md-3 col-sm-6 mb-4">
                        <div class="card-product wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                            ...
                            <div class="card-product-info">
                                ...
                                <span class="price">₹ <?= htmlspecialchars($product['b2c_price']) ?></span>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
