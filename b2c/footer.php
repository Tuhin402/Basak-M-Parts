        ...
        <div class="footer-body">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="footer-menu">
                            <div class="footer-col-block">
                                <div class="footer-heading text-button footer-heading-mobile">Pages</div>
                    ...
                    <div class="col-lg-4">
                        <div class="footer-col-block">
                            <div class="footer-heading text-button footer-heading-mobile">Sign Up</div>
                            <div class="tf-collapse-content">
                                <div class="footer-newsletter">
                                    ...
                                    <form id="subscribe-form" action="#" class="form-newsletter subscribe-form style-black" method="post" accept-charset="utf-8" data-mailchimp="true">
                                        <div id="subscribe-content" class="subscribe-content">
                                            <div class="email">
                                                <a href="register.php" class="btn btn-sm btn-outline-danger fw-bold fs-22 px-3 py-2 rounded-pill mt-3">Register  🡥</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
