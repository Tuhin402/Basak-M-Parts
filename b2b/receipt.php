                ...
                <div id="invoiceSection" class="row justify-content-center">
                    <div class="col-12 col-lg-12 col-xl-9 col-xxl-8">
                                    ...
                                    <table class="table table-hover align-middle table-bordered">
                                        ...
                                        <tbody class="table-group-divider">
                                            ...
                                            foreach ($products as $product) {
                                                ...
                                                // $sql = "SELECT SUM(shipping_price) FROM products WHERE id = $product_id";
                                                // $shippings = $obj->fetch('$sql');
                                                // foreach ($shippings as $shipping) {
                                                //     $shipping = $shippings['shipping_price']; 
                                                // }
                        ...
                        <div class="row my-5">
                            ...
                            <!--    <h5>Shipping Charges : <span class="text-success fw-semibold">₹ <?= $shipping ?></span></h5>-->
                            <!--</div>-->
                            <div class="col-12 text-end">
