                                        ...
                                        <div class="card-product wow fadeInUp" data-wow-delay="0.1s">
                                            <div class="card-product-wrapper">
                                                ...
                                                <div class="list-product-btn">
                                                    <button type="button" class="box-icon wishlist btn-icon-action border-0 p-3" data-product-id="<?= $product['id'] ?>" data-price="<?= $product['b2b_price'] ?>">
                                                ...
                                                <div class="list-btn-main">
                                                    <button type="button" class="btn-main-product add-to-cart" data-product-id="<?= $product['id'] ?>" data-price="<?= $product['b2b_price'] ?>">
                                                        Add To Cart
                                                    </button>
                                                </div> 
                                            </div>
