        ...
        <section class="flat-spacing page-404">
            <div class="container">
                <div class="page-404-inner">
                    <div class="image">
                        <img class="lazyload" data-src="images/404.png" src="images/section/404.png" alt="image">
                    </div>
                    <div class="content">
                        ...
                        <a href="index.php" class="tf-btn btn-fill"><span class="text text-button">Back To Homepage</span></a>
                    </div>
                </div>
            </div>
        </section>
