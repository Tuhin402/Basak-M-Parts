<div class="offcanvas offcanvas-start canvas-filter" id="filterShop">
    <div class="canvas-wrapper">
        ...
        <div class="canvas-body">
            ...
            <!-- price range -->
            <?php
            $query = "SELECT MIN(b2b_price) AS min_b2b_price, MAX(b2b_price) AS max_b2b_price FROM products";
            $result = $obj->fetch($query);

            $min_price = !empty($result[0]['min_b2b_price']) ? $result[0]['min_b2b_price'] : 1;
            $max_price = !empty($result[0]['max_b2b_price']) ? $result[0]['max_b2b_price'] : 10000;
            ?>
