                            ...
                            <table class="tf-table-page-cart">
                                ...
                                <tbody>
                                    ...
                                    if (isset($_SESSION["b2b_user_id"])) {
                                        ...
                                        $cartQuery = "SELECT * FROM cart WHERE b2b_id = '$userId'";
                                            ...
                                            foreach ($cartItems as $cartItem) {
                                                ...
                                                <tr class="tf-cart-item file-delete" data-product-id="<?= $productId ?>">
                                                    ...
                                                    <td data-cart-title="Price" class="tf-cart-item_price text-center">
                                                        <div class="cart-price text-button price-on-sale">₹<?= $productPrice ?></div>
                                                    </td>
                                    ...
                                    <?php } } else { 
                                        ...
                                        echo '<tr><td colspan="5" class="text-center"><a href="login_B_to_B.php" class="fw-bold text-danger">Login -</a> to see cart details</td></tr>';
                                    } ?>
                                </tbody>
                            </table>
                        </form>
                    ...
                    <div class="col-xl-4">
                        <div class="fl-sidebar-cart">
                            <div class="box-order bg-surface">
                                ...
                                if (isset($_SESSION["b2b_user_id"])) {
                                    $userId = $_SESSION["b2b_user_id"];
                                    $cartQuery = "SELECT SUM(total_price) AS subtotal, COUNT(*) AS totalItems, SUM(shipping_price) AS shipAmount FROM cart WHERE b2b_id = '$userId'";
