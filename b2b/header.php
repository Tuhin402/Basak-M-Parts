...
$userId = isset($_SESSION["b2b_user_id"]) ? $_SESSION["b2b_user_id"] : null;
$userName = isset($_SESSION["b2b_user_name"]) ? $_SESSION["b2b_user_name"] : null;
?>
            ...
            <div class="row wrapper-header align-items-center line-top-rgba">
                ...
                <div class="col-xl-8 col-md-4 col-6">
                    <div class="wrapper-header-left justify-content-center justify-content-xl-start">
                        <a href="index.php" class="logo-header"><img src="images/logo-white.png" alt="Basak logo" class="logo"></a>
                        ...
                        <ul class="nav-icon d-flex justify-content-end align-items-center">
                            ...
                            <li class="nav-account">
                                ...
                                <div class="dropdown-account dropdown-login">
                                    <div class="sub-top">
                                        ...
                                        <?php else: ?>
                                            <a href="login_B_to_B.php" class="tf-btn btn-reset">Login</a>
                                            <p class="text-center text-secondary-2">
                                                Don’t have an account? <a href="register_B_to_B.php">Register</a>
                                            </p>
                                        <?php endif; ?>
                                    </div>
                                    <?php if ($userId): ?>
                                        <div class="sub-bot d-flex flex-column align-items-center justify-content-center gap-2">
                                            ...
                                            <a class="tf-btn btn-reset" href="logout_b2b.php">Logout</a>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </li>
                            <li class="nav-wishlist">
                                <a href="wish-list.php" class="nav-icon-item">
                                    ...
                                    <?php if ($userId): 
                                        $wishlistCountQuery = "SELECT COUNT(*) as total FROM wishlist WHERE b2b_id = '$userId'";
                            ...
                            <li class="nav-cart">
                                <a href="shopping-cart.php" class="nav-icon-item">
                                    ...
                                    <?php if ($userId): 
                                        $cartCountQuery = "SELECT COUNT(*) as total FROM cart WHERE b2b_id = '$userId'";
                ...
                <div class="box-left">
                    ...
                    <nav class="box-navigation">
                        <ul class="box-nav-ul d-flex align-items-center">
                            ...
                            <?php if (!$userId): ?>
                                <li class="menu-item"><a href="../b2c/index.php" class="item-link text-white">B2C</a></li>
                            <?php endif; ?>
                        </ul>
                    </nav>
                </div>
        ...
        <div class="mb-body">
            <div class="mb-content-top">
                <ul class="nav-ul-mb" id="wrapper-menu-navigation">
                    ...
                    <li class="nav-mb-item">
                        ...
                        <div id="dropdown-menu-main" class="collapse">
                            <ul class="sub-nav-menu sub-menu-level-2">
                                <!-- Products Submenu -->
                                <li class="nav-mb-item">
                                    <a href="#dropdown-menu-products" class="collapsed mb-menu-link" data-bs-toggle="collapse"
                                ...
                                <li><a href="returnpolicy.php" class="sub-nav-link">Return Policy</a></li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <?php if ($userId) { ?>
                        ...
                        <li class="nav-mb-item mt-4"><a href="logout_b2b.php" class="tf-btn btn-reset">Logout</a></li>
                    <?php } else { ?>
                        <li class="nav-mb-item"><a href="../b2c/index.php" class="mb-menu-link text-primary fw-bold">B2C</a></li>
                    <?php } ?>
                </ul>
            </div>
            <div class="mb-other-content">
                <div class="group-icon">
                    ...
                    <?php else: ?>
                        <a href="login_B_to_B.php" class="site-nav-icon">
