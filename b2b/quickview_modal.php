                    ...
                    <div class="tf-product-info-heading">
                        ...
                        <div class="tf-product-info-desc">
                            <div class="tf-product-info-price">
                                <h5 class="price-on-sale font-2">₹ <?= htmlspecialchars($product['b2b_price']) ?></h5>
                                <div class="compare-at-price font-2">₹ <?= htmlspecialchars($product['mrp']) ?></div>
                                <?php if($product['b2b_discount'] != 0) { ?>
                                <div class="badges-on-sale text-btn-uppercase">-<?= htmlspecialchars($product['b2b_discount']) ?>%</div>
                                <?php } ?>
                            </div>
