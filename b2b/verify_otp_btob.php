...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$email) {
        ...
        echo json_encode(['success' => false, 'message' => 'Email is required'], JSON_PRETTY_PRINT);
        exit;
    }
    ...
    <html>
        ...
        <body>
            <div class='container'>
                <div class='header'>
                    <img src='https://basakmparts.com/b2b/images/logo-white.png' alt='Basak M Parts Logo'>
                </div>
                <div class='content'>
                    <h1>Hello, User!</h1>
                    <p>Your OTP code for B2B registration is:</p>
